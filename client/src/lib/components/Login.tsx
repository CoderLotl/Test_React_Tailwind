...
import { Login_fn } from '../pages/LoginPage';
    ...
    return (
        ...
        <div id='login_body' className='bg-slate-200'>
            <div id='login_inputs' className='flex flex-col px-[50px] py-[50px]'>
                <input id='login_username' placeholder='Username' type='text'
                ...
                <button onClick={() => Login_fn} className='bg-emerald-700 hover:cursor-pointer p-2 hover:bg-orange-700
